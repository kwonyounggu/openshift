...
<script type="text/javascript">
	...
	$(document).ready(function ()
	{
			  ...
			  'core' : 
			  {
				    ...
				    'data':
				    {
				    	'url': function(node)
				    	{
				    		...
				    		return (node.id==='#' ? '//www.webmonster.ca/jsp/menu_response_tablet/json_hvac/manuals_brands.jsp' : '//www.webmonster.ca/jsp/menu_response_tablet/json_hvac/manuals_brands_children.jsp');
				    	},
				    	'type': 'post',
				    	'dataType': 'json',
				    	'data': function(node)
		...
		*/
		...
		$.get('http://www.webmonster.ca/jsp/menu_response_tablet/json_hvac/hvac_manuals_model_number.jsp', function(data)
		{
			g_modelList=data;
			//log(data);

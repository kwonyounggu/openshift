					...
					<tr>
			   		...
			   		<tr>
			   			<td class='estimate_form_td' colspan='2'>Please select the elephant before submitting <span style='font-size: .95em; color: #8fc161;' id='check_robot_span'>*</span>
			   				<!-- To hide the input but only to display the error message -->
			   				<input type='text' style='width: 0px; height: 0px; border: none;' name='select_animal' id='select_animal' value='1'/>
			   				<br />
			   				<input type='radio' style='margin-right: 100px; margin-left: 50px; outline: 0px' name='animalGroup' id='animal_1' value='1'/>
			   				<input type='radio' style='margin-right: 100px; outline: 0px' name='animalGroup' id='animal_2' value='2'/>
			   				<input type='radio' style='outline: 0px' name='animalGroup' id='animal_3' value='3'/>

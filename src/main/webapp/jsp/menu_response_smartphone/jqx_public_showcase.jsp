...
<div style="width: 100%" id="menu_contents">
	...
	<div id="padiatric_reference_interval" class="carousel slide">
	  ...
	  <a class="left carousel-control" href="#padiatric_reference_interval" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#padiatric_reference_interval" role="button" data-slide="next">
	...
	<div class="showcase_rectangle" style="margin-top: 2em">
		<strong>Clinical Research Project for  Cardiopulmonary Arrests</strong>:
	...
	<div id="sickkidsCarousel_carm" class="carousel slide">
	  ...
	  <div class="carousel-inner" role="listbox">
	   ...
	   <!--  <div class="item">
	      <img src="images/freelance_showcase/carm_login.PNG" class="img-thumbnail" alt="carm_login.PNG">
	    </div>
	
	    <div class="item">
	      <img src="images/freelance_showcase/carm_labdata_result.PNG" class="img-thumbnail" alt="carm_labdata_result.PNG">
	    </div>
	
	    <div class="item">
	      <img src="images/freelance_showcase/carm_diagnostices_problems.PNG" class="img-thumbnail" alt="carm_diagnostices_problems.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/carm_data_review.PNG" class="img-thumbnail" alt="carm_data_review.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/carm_admin.PNG" class="img-thumbnail" alt="carm_admin.PNG">
	    </div> -->
	  </div>
	
	  <!-- Left and right controls -->
	  <a class="left carousel-control" href="#sickkidsCarousel_carm" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#sickkidsCarousel_carm" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	    <span class="sr-only">Next</span>
	  </a>
	</div>
	<!-- EPOCH -->
	<div class="showcase_rectangle" style="margin-top: 2em">
		<strong>Clinical Research Project for  EPOCH (Evaluating Processes of care & the Outcomes of Children in Hospital)</strong>, An 18-month cluster randomized trial to evaluate the impact of Bedside Paediatric Early Warning System
on clinical outcomes, processes of care and resource utilization in 22 paediatric hospitals worldwide:
		The Hospital for Sick Children, Java, Action script 3.0, HTML/CSS, JQuery/Javascript, Apache Tomcat 5.5/6.0, PostGresql, Oracle	
	</div>
	<div id="sickkidsCarousel_epoch" class="carousel slide">
	  <!-- Indicators -->
	  <ol class="carousel-indicators">
...
<!-- 	    <div class="item">
	      <img src="images/freelance_showcase/epoch_data_entry_verification.PNG" class="img-thumbnail" alt="epoch_data_entry_verification.PNG">
	    </div>
	
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_files_for_review.PNG" class="img-thumbnail" alt="epoch_files_for_review.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_forum.PNG" class="img-thumbnail" alt="epoch_forum.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_substudies_2.PNG" class="img-thumbnail" alt="epoch_substudies_2.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_substudies.PNG" class="img-thumbnail" alt="epoch_substudies.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_tracking_hostory.PNG" class="img-thumbnail" alt="epoch_tracking_hostory.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_upload_history.PNG" class="img-thumbnail" alt="epoch_upload_history.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/epoch_upload_study_doc.PNG" class="img-thumbnail" alt="epoch_upload_study_doc.PNG">
	    </div> -->
	  </div>
	
	  <!-- Left and right controls -->
	  <a class="left carousel-control" href="#sickkidsCarousel_epoch" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	...
	<div id="sickkidsCarousel_exemplar" class="carousel slide">
	  ...
	  <div class="carousel-inner" role="listbox">
	    ...
	    <!-- <div class="item">
	      <img src="images/freelance_showcase/exemplar_demographics.PNG" class="img-thumbnail" alt="exemplar_demographics.PNG">
	    </div> -->
	  </div>
	  ...
	  <a class="right carousel-control" href="#sickkidsCarousel_exemplar" role="button" data-slide="next">
		...
		<!-- SPIRE -->
	<div class="showcase_rectangle" style="margin-top: 2em">
		<strong>Clinical Research Project for  SPIRE</strong> (Sequential Prospective Introspective Resident Enunciations):
		The Hospital for Sick Children, Java, Action script 3.0, HTML/CSS, JQuery/Javascript, Apache Tomcat 5.5/6.0, PostGresql, Oracle	
	</div>
	<div id="sickkidsCarousel_spire" class="carousel slide">
	  <!-- Indicators -->
	  <ol class="carousel-indicators">
	  ...
	  <div class="carousel-inner" role="listbox">
	    ...
	    <!-- <div class="item">
	      <img src="images/freelance_showcase/spire_home.PNG" class="img-thumbnail" alt="spire_home.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/spire_login.PNG" class="img-thumbnail" alt="spire_login.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/spire_admin_forum_thread_management.PNG" class="img-thumbnail" alt="spire_admin_forum_thread_management.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/spire_admin_participant_accounts.PNG" class="img-thumbnail" alt="spire_admin_participant_accounts.PNG">
	    </div>
	    <div class="item">
	      <img src="images/freelance_showcase/spire_participation_status.PNG" class="img-thumbnail" alt="spire_participation_status.PNG">
	    </div> -->
	  </div>
	
	  <!-- Left and right controls -->
	  <a class="left carousel-control" href="#sickkidsCarousel_spire" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#sickkidsCarousel_spire" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	    <span class="sr-only">Next</span>
	  </a>
	</div>
	...
	<div id="others_others" class="carousel slide">
	  <!-- Indicators -->
	  <ol class="carousel-indicators">
	    <li data-target="#others_others" data-slide-to="0" class="active"></li>
	    <li data-target="#others_others" data-slide-to="1"></li>
	    <li data-target="#others_others" data-slide-to="2"></li>
	    <li data-target="#others_others" data-slide-to="3"></li>
	  ...
	  <!-- Left and right controls -->
	  <a class="left carousel-control" href="#others_others" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#others_others" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	    <span class="sr-only">Next</span>
	  </a>
	</div>

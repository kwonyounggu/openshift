...
<table style='table-layout: fixed'>
	<tr>
		...
		<td style='width: 73%; border-radius:0px 0px 0px 0px; border:1px solid #dddddd; border-style: hidden hidden hidden solid; vertical-align: top;'>
			...
			<div><br/><p style="padding-left: 20px;">Don't forget to <span class="label label-info">leave a comment/request</span> if this page has helped you.</p></div>
			<div style="width: 100%" class="fb-comments" data-href="http://www.webmonster.ca/controller?op=menu_public_hvac#system_manual" data-numposts="5" data-order-by="reverse_time"></div>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td style='width: 75%; border-radius:0px 0px 0px 0px; border:1px solid #dddddd; border-style: hidden hidden hidden solid; vertical-align: top;'>
			...
			<div class='embed-container'>
				<iframe id='pdfIfram' src='https://www.dropbox.com/s/acnim6xfo99h608/Scheduled_admin_carrier_air_conditioner_brochure_24aaa5_01-824-106-25_2016_07_03_15_06_32.pdf#page=2&view=Fit?raw=1' style='border:0' onload='resizeIframe(this)'></iframe>
			</div>

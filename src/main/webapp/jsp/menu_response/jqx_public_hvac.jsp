...
<div style="width: 95%">
  <ul class="nav nav-tabs">
  	<li class="active"><a data-toggle="tab_ajax" data-target="#residential_manuals" href="jsp/menu_response/ajax_hvac/ajax_hvac_residential_manuals.jsp">System Manuals</a></li>

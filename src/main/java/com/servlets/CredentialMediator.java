...
public class CredentialMediator
{
	   ...
	   static 
	    {
	        ...
	        {
	            t.printStackTrace();
	            System.err.println("ERROR: failed in getting TRANSPORT, msg="+t);
	        }
	    }
	  /**
	   ...
	   */
	  public CredentialMediator(HttpServletRequest request, InputStreamReader clientSecretsStreamReader, Collection<String> scopes) throws InvalidClientSecretsException 
	  {
	    ...
	    try 
	    {
	      secrets = GoogleClientSecrets.load(JSON_FACTORY, clientSecretsStreamReader);
	    } 
	    catch (IOException e) 
	    {

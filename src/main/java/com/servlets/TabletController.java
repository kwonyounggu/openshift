	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			else if(op.indexOf("menu")!=-1)
			{
				...
				{
					request.setAttribute("body_panel", "/jsp/menu_response_tablet/jqx_public_showcase.jsp");
				}
				else if(op.equals("menu_public_contact"))
				{
					request.setAttribute("body_panel", "/jsp/menu_response_tablet/jqx_public_contact.jsp");
				}
				else if(op.equals("menu_public_stockcharts"))
				{
					request.setAttribute("body_panel", "/jsp/menu_response_tablet/jqx_public_stockcharts.jsp");
				}
				else if(op.equals("menu_public_hvac"))
				{
					request.setAttribute("body_panel", "/jsp/menu_response_tablet/jqx_public_hvac.jsp");
				}
				else if(op.equals("menu_public_saxophone"))
				{
					request.setAttribute("body_panel", "/jsp/menu_response_tablet/jqx_public_saxophone.jsp");
				}
